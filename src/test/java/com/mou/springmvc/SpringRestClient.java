...
import com.mou.springmvc.model.User;
...
import com.mou.springmvc.model.AuthTokenInfo;

public class SpringRestClient {

    public static final transient Log log = LogFactory.getLog(SpringRestClient.class);

    public static final String REST_SERVICE_URI = "http://localhost:8080/brookside-spring-example";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8080/brookside-spring-example/oauth/token";
    
    public static final String QPM_PASSWORD_GRANT = "?grant_type=password&username=mou&password=mou123";
	...
	private static AuthTokenInfo sendTokenRequest(){
        ...
        if(map!=null){
            ...
            log.info("User Token information :" +tokenInfo );
    ...
    private static void createUser(AuthTokenInfo tokenInfo) {
        ...
        log.debug("Testing create User API");
        RestTemplate restTemplate = new RestTemplate();
    ...
    private static void updateUser(AuthTokenInfo tokenInfo) {
        ...
        log.debug("Testing update User API....");
    ...
    private static void deleteUser(AuthTokenInfo tokenInfo) {
    	Assert.notNull(tokenInfo, "Authenticate first please......");
        log.debug("Testing delete User API....");
    ...
    private static void deleteAllUsers(AuthTokenInfo tokenInfo) {
        ...
        log.debug("Testing all delete Users API....");
        RestTemplate restTemplate = new RestTemplate();
        HttpEntity<String> request = new HttpEntity<String>(getHeaders());
